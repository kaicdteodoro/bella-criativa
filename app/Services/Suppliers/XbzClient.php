...
class XbzClient
{
    ...
    private function inferCategory(string $descricao): ?string
    {
        ...
        return match (true) {
            ...
            str_contains($text, 'fone de ouvido'), str_contains($text, 'headphone'), str_contains($text, 'earphone'), str_contains($text, 'earbuds') => 'Fones de Ouvido',
            str_contains($text, 'power bank'), str_contains($text, 'powerbank'), str_contains($text, 'carregador portatil') => 'Power Banks',
            str_contains($text, 'almofada') => 'Almofadas',
            str_contains($text, 'squeeze') => 'Squeezes',
            str_contains($text, 'garrafa') => 'Garrafas',
